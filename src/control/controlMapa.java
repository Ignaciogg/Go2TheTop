...
public class controlMapa extends Application implements MapComponentInitializedListener, 
ElevationServiceCallback, GeocodingServiceCallback, DirectionsServiceCallback  {
   ...
   /* protected void configureMap() {
    ...
    public void mapInitialized() {
        ...
        LatLong center = new LatLong(40.4165, -3.70256);
...
//        System.out.println("Heading is: " + map.getHeading() );
        ...
        LatLong markerLatLong = new LatLong(40.4165, -3.70256);
        ...
        LatLong markerLatLong2 = new LatLong(40.3718, -3.9189527);
        ...
        LatLong markerLatLong3 = new LatLong(40.4178, -3.9989527);
        markerOptions2.position(markerLatLong3)
                .title("My new Marker")
                .visible(true);
...
//        System.out.println("Bounds : " + map.getBounds());
        ...
        LatLong[] ary = new LatLong[]{markerLatLong, markerLatLong2, markerLatLong3};
